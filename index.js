    ...
    pickButtons.forEach(picker => {
      picker.addEventListener('click',(e) =>{
        ...
        setTimeout(function(){
          ...
          checking(playerpick,computerOptions);
          
          playerHand.src = `img/${playerpick}.png`;
         /* computerHand.src = `/img/${computerChoice}.png`;*/
         
         if(playerpick === 'rock'){
           computerHand.src = `img/${computerOptions[1]}.png`;
           return;
         }
         if(playerpick === 'paper'){
           computerHand.src = `img/${computerOptions[2]}.png`;
         }
         if(playerpick === 'scissor'){
           computerHand.src = `img/${computerOptions[0]}.png`;
         }
